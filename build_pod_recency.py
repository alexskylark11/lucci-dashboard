...
PATH = r'C:\Users\AlexBerger\Downloads\Lucci_Product Locator File + Depletion report (20).xlsx'
...
PERSON_NAME_PATTERN = re.compile(
    # ALL-CAPS two-token names with a DOUBLE space (Ethica's rep-name format,
    # e.g. "KRATZKE  ROBERT"). Single-space and mixed-case patterns were
    # dropped because they mis-caught real businesses (Total Wine, Atlas
    # Restaurant, The Butler Pantry, etc.).
    r'^[A-Z]{4,}\s{2,4}[A-Z]{3,}$')
